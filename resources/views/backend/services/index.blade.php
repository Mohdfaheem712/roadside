            ...
            <div class="card-header">
              <div class="row bg-gradient shadow-black border-radius-lg">
                <div class="col-6 d-flex align-items-center">
                  <h4 class="text text-capitalize ps-3">Services</h4>
                </div>
                <div class="col-6 text-end">
                  <a class="btn bg-gradient-dark mb-0" href="{{ route('admin.addService') }}">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <div class="avatar avatar-xl position-relative">
                        <img src="{{ Storage::url($service->icon_url) }}" alt="profile_image" class="w-100 border-radius-lg shadow-sm gallery_img">
                      </div>
                      </td>
                      ...
                      <td>
                        <div class="ms-auto text-end">
                          <a class="btn btn-link text-dark px-3 mb-0" href="{{ route('admin.editService',$service->id) }}"><i class="material-icons text-sm me-2">edit</i>Edit</a>
                          <form method="post" action="{{ route('admin.deleteService',$service->id) }}" style="display:inline-block;">
                            @csrf
